...
class User(db.Model):
    ...
    image_file = db.Column(db.String(20), nullable=False, default='default.jpg') #Profile picture. Going to use hash, so max character should be 20.
...
@app.route("/test")
def test_page():
    return render_template('test1.html', title='Test')